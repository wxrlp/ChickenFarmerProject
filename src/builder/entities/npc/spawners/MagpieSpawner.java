...
public class MagpieSpawner extends HelperSpawner implements Spawner {
    private static final int DEFAULT_SPAWN_INTERVAL = SpawnerBaseValues.MAGPIE_SPAWN_INTERVAL;

    /** Creates a magpie spawner at the given coordinates with the default spawn interval. */
    public MagpieSpawner(int x, int y) {
        super(x, y, DEFAULT_SPAWN_INTERVAL);
    }

    /** Creates a magpie spawner at the given coordinates with a custom spawn interval. */
    ...
    /** Spawns a magpie at the spawner's location when the timer is finished. */
    @Override
