...
public
class EnemyManager implements Tickable, Interactable,
        RenderableGroup {
    ...
    public
    EnemyManager(Dimensions dimensions) {
    }
     ...
     */
    public
    Magpie makeMagpie(Player player) {
        final Magpie magpie = new Magpie(this.spawnX, this.spawnY,
                player);
     ...
     */
    public
    Pigeon makePigeon(HasPosition hasPosition) {
        final Pigeon pigeon = new Pigeon(this.spawnX, this.spawnY,
                hasPosition);
     ...
     */
    public
    Eagle makeEagle(Player player) {
        return new Eagle(this.spawnX, this.spawnY, player);
    }

    public
    void spawnEagle(int x, int y, Player player) {
        this.spawnX = x;
        this.spawnY = y;
