...
/**
 * A world load exception occurs when trying to load an invalid
 * world. This exception indicating
 * some sort of processing error in {@link WorldBuilder}.
 *
 * <p>As this exception occurs when reading from a world encoding,
 * two alternative constructors
 * ({@link #WorldLoadException(String, int)} and
 * {@link #WorldLoadException(String, int, int)}) are
 * used to provide additional line number and character position
...
public class WorldLoadException extends Exception {
    ...
    /**
     * Construct a new world load exception with a message detailed
     * the problem.
     *
    ...
    /**
     * Construct a new world load exception that occurred loading a
     * particular row.
     *
     * @param message Explanation of the problem that occurred.
